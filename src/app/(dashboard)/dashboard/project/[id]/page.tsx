    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          <div className="h-10 w-10 rounded-xl border border-slate-500/15 bg-slate-500/10 animate-pulse" />
          <div className="space-y-1">
            <div className="h-5 w-48 rounded bg-slate-500/20 animate-pulse" />
            <div className="h-4 w-24 rounded bg-slate-500/10 animate-pulse" />
          </div>
        </div>
      </div>
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {SKELETON_ICONS.slice(0, 6).map((Icon, i) => (
          ...
          >
            <div className="flex items-center gap-2 border-b border-slate-500/10 px-4 py-3">
