    ...
    <div className="min-h-screen space-y-8 bg-zinc-950 text-zinc-100">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 rounded-xl border border-[#6366f1]/30 bg-[#6366f1]/10 px-4 py-2 text-sm font-medium text-[#818cf8] transition-colors hover:bg-[#6366f1]/20"
        >
      ...
      <section className="space-y-3">
        ...
        <div className="overflow-hidden rounded-xl border border-zinc-800/50 bg-zinc-900/40">
          <table className="w-full text-left text-sm">
            <thead>
              <tr className="border-b border-zinc-800/50">
                ...
                <th className="px-4 py-3 font-medium text-zinc-400">Stripe</th>
              </tr>
            </thead>
            <tbody>
        ...
        {withSubscription.length === 0 && (
          <p className="text-zinc-500">Nog geen actieve abonnementen.</p>
        )}
      </section>
      ...
      <section className="space-y-3">
        ...
        {trial.length === 0 && <p className="text-zinc-500">Niemand in trial.</p>}
      </section>
